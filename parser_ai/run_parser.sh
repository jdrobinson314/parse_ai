...
if [[ "$1" == "--help" || "$1" == "-h" ]]; then
    ...
    echo "  -m, --merge-to DIR   Merges reconstructed files into a single unified directory (e.g. ./my_app)"  --clean-project, -cp Automatically merge into a 'merged_project' subfolder."
    echo ""
    echo "Structure:"
